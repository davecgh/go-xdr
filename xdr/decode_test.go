...
var structTestWant = allTypesTest{
	127,                                     // A
	255,                                     // B
	32767,                                   // C
	65535,                                   // D
...
// unmarshalTests houses all of the tests to be performed against the Unmarshal
// function.
...
// decodeTests houses all of the tests performed against the public functions of
// the Decoder object.
