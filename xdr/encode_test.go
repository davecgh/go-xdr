...
// testInterface is used to test Marshal with values nested in an interface.
var testInterface interface{} = 17

// structMarshalTestIn is input data for the big struct test of all supported types.
var structMarshalTestIn = allTypesTest{
	127,                                // A
	255,                                // B
	32767,                              // C
	65535,                              // D
...
// structMarshalTestIn.
var structMarshalTestWant = []byte{
...
// marshalTests houses all of the tests to be performed against the Marshal
// function.
...
// encodeTests houses all of the tests performed against the public functions of
// the Encoder object.
